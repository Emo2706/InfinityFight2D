...
Shader "S_HexWall"
{
	Properties
	{
		...
		_SpeedHex("SpeedHex", Vector) = (0,0,0,0)
		_HexBackgroundColor("HexBackgroundColor", Color) = (0.06123176,0.2943663,0.3018868,0)
		_HexPatternColor("HexPatternColor", Color) = (0,0.9233861,1,0)
		_Tiling("Tiling", Vector) = (-0.36,0,0,0)
		[ASEEnd]_AlphaClip("AlphaClip", Range( 0 , 1)) = 0.3273351
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _HexBackgroundColor;
			float4 _HexPatternColor;
			float2 _SpeedHex;
			float2 _Tiling;
			float _AlphaClip;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord10 = IN.ase_texcoord3.xy * _Tiling + float2( 0,0 );
				float2 panner13 = ( 1.0 * _Time.y * _SpeedHex + texCoord10);
				float4 tex2DNode14 = tex2D( _TextureSample0, panner13 );
				float4 lerpResult12 = lerp( _HexBackgroundColor , _HexPatternColor , tex2DNode14);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult12.rgb;
				float Alpha = tex2DNode14.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord2.xy * _Tiling + float2( 0,0 );
				float2 panner13 = ( 1.0 * _Time.y * _SpeedHex + texCoord10);
				float4 tex2DNode14 = tex2D( _TextureSample0, panner13 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord.xy * _Tiling + float2( 0,0 );
				float2 panner13 = ( 1.0 * _Time.y * _SpeedHex + texCoord10);
				float4 tex2DNode14 = tex2D( _TextureSample0, panner13 );
				

				surfaceDescription.Alpha = tex2DNode14.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord1.xy * _Tiling + float2( 0,0 );
				float2 panner13 = ( 1.0 * _Time.y * _SpeedHex + texCoord10);
				float4 tex2DNode14 = tex2D( _TextureSample0, panner13 );
...
Node;AmplifyShaderEditor.SamplerNode;14;-569.3979,-124.6;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;1cc01744c2a7d4d49afce7068ba7fce5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;13;-788.2975,-93.00009;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1045.797,-94.50005;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;19;-1256.21,15.03651;Inherit;False;Property;_Tiling;Tiling;4;0;Create;True;0;0;0;False;0;False;-0.36,0;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;15;-1009.353,50.9355;Inherit;False;Property;_SpeedHex;SpeedHex;1;0;Create;True;0;0;0;False;0;False;0,0;0,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;243.7,-288.9996;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_HexWall;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638505319936831218;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.ColorNode;17;-516.7548,-328.0644;Inherit;False;Property;_HexPatternColor;HexPatternColor;3;0;Create;True;0;0;0;False;0;False;0,0.9233861,1,0;0,0.9233861,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;12;-116.4999,-381.1987;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;16;-465.7548,-520.0644;Inherit;False;Property;_HexBackgroundColor;HexBackgroundColor;2;0;Create;True;0;0;0;False;0;False;0.06123176,0.2943663,0.3018868,0;0.2226771,0.3396226,0.3396226,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-138.2383,-77.41251;Inherit;False;Property;_AlphaClip;AlphaClip;5;0;Create;True;0;0;0;False;0;False;0.3273351;0.05882353;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=26DEC819073D563809139B460FEE2F08FD120ED1